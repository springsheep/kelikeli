<template>
    <div class="container"style="height: 100%">
        <div style="height: 80.5%">
            ...
            <!-- 登录 -->
            <div class="head" style="font-size: .767rem">物业入口</div>
            <div class="useLogin">
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            // 获取验证码
            include() {
                this.$refs.ppp.disabled = true;
                if (this.$refs.ppp.innerHTML == '重新发送' || this.$refs.ppp.innerHTML == '发送验证码') {
                ...
                if (this.a == 1 && this.b == 1) {
                    ...
                    this.axios(options).then((response) => {
                        ...
                        if (this.state1 === "1") {
                            ...
                            localStorage.setItem("mobilePhoneNo", this.msg2);
                            localStorage.setItem("WmobilePhoneNo", this.msg2);
                            //将要绑定过的物业传送过去
                            this.$store.state.bindwuye = response.data.data;
