  ...
  <div class="content">
    <div>
      <!--<van-cell-group>-->
        ...
        <!--/>-->
      <!--</van-cell-group>-->
      <mt-field label="当前位置" :placeholder="location"  style="color: #666666"></mt-field>
      ...
      <div class="photo_photo">
        <label for="choose1" style="">
          <div class="img">
            ...
            <img :src="src2" alt="" v-if="src22!=null">
          </div>
        </label>
        <label for="choose" style="">
          <div class="img">
            ...
            <img :src="src1" alt="" v-if="src11!=null">
          </div>
        </label>
...
<script>
  ...
  export default {
    ...
    created() {
      // console.log(this.$store.state.bindcarinfo)
    },
    methods: {
      ooooo() {
        console.log(13223124)
      },
      //点击获取对方电话号码
      actieve() {
        if (this.buttonstate == 1) {
          ...
          const option = {
            method: 'POST',
            url: 'moveCar/getCarOwnerMobilePhoneNo',
            data: {
      ...
      yanzheng(carImage, flag) {
        ...
        const option = {
          method: 'POST',
          url: 'moveCar/moveCarSceneImageUpload',
          data: formData
        };
        this.axios(option).then((res) => {
          Indicator.close();
