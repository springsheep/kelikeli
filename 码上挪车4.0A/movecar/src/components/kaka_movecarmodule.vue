  ...
  export default {
    ...
    data() {
      return {
        ...
        qrCode: JSON.parse(sessionStorage.getItem('movecarInfo')).qrCode,
        num: 6,
...
// 用户点击了分享后执行的回调函数
      ...
      sendemail() {
        MessageBox.prompt('请输入邮箱', {
          ...
          this.axios.post('moveCar/sendMoveCarQrCodeEmail',
            {
              "openId": this.openId,
              "qrCode": this.qrCode,
              "email": val.value
      ...
      choose(m, e) {
        ...
        this.axios.post('moveCar/changeMoveCarQrCodeSkin', {
          "openId": this.openId,
          "qrCode": this.qrCode,
          "backgroundFlag": m - 1
        }).then((res) => {
