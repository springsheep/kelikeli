    ...
    <div style="min-height: 94%">
      ...
      <div class="input">
        ...
        <div style="position:relative;">
          ...
          <div style="position: absolute;right: .0rem;bottom: .55rem;width: 2rem;text-align: right;padding-right: .6rem" @click="choosecar">
    ...
    methods: {
      ...
      next() {
        ...
        if (!(/^(([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-Z](([0-9]{5}[DF])|([DF]([A-HJ-NP-Z0-9])[0-9]{4})))|([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-Z][A-HJ-NP-Z0-9]{4}[A-HJ-NP-Z0-9挂学警港澳使领]))$/.test(this.input1))) {
          ...
          this.axios.post('moveCarB/bindMoveCarQrCode', {
            "openId": this.openId,
            "carNo": this.input1,
