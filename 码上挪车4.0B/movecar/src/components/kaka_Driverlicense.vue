...
<template>
  <div class="content">
    ...
    <input type="file" id="choose" accept="image/*" capture="camera"
           ...
           style="position: fixed;left: 1000rem"
           ref="file">
    <div class="title">请拍摄驾驶证正反面，保证全张入镜</div>
    <div class="one">
      <label for="choose1">
      <div class="img">
        <img src="../assets/52.png" alt="" v-if="src==null">
    ...
    <div class="one">
      <label for="choose">
      <div class="img">
        <img src="../assets/53.png" alt="" v-if="src1==null">
